...
public class Constant {
    public static final int ITEM_PAGE = 21;
    ...
    public static final int WIDTH_ITEM_GRID = 7;
    ...
    public static final String PACKAGE_APP_LAUNCHER = "com.gsmart";
    ...
    public static final String PACKAGE_APP = "com.wallpad.delivery";
}
