...
public class TcpClient {
    ...
    public static final String SERVER_IP = "124.111.208.72"; //your computer IP address
...
//            socket.setTcpNoDelay(true);
            LogUtils.e("Socket connected --- "+ socket.isConnected());
            try {
